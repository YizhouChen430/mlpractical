...
class BatchNormalizationDimReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(BatchNormalizationDimReductionBlock, self).__init__()
...
class ResidualBatchNormalizationConvBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ResidualBatchNormalizationConvBlock, self).__init__()
...
class ResidualBatchNormalizationDimReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ResidualBatchNormalizationDimReductionBlock, self).__init__()
