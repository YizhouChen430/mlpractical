...
if args.block_type == 'conv_block':
    ...
    processing_block_type = BatchNormalizationConvBlock
    dim_reduction_block_type = BatchNormalizationDimReductionBlock
elif args.block_type == 'bnrc_block':
    processing_block_type = ResidualBatchNormalizationConvBlock
    dim_reduction_block_type = ResidualBatchNormalizationDimReductionBlock
else:
